...
public class lexico extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 0, 120, 40));

        lex.setFont(new java.awt.Font("Yu Gothic UI", 0, 24)); // NOI18N
        lex.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                lexKeyReleased(evt);
            }
        ...
        jPanel1.add(scrollErrores, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 520, 420, 150));

        jButton2.setText("Errores Lexico");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 480, -1, -1));
...
private AttributeSet obtenerEstilo(String tipoToken) {
    ...
    private javax.swing.JTextPane lex;
